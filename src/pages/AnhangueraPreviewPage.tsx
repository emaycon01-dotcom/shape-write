...
export default function AnhangueraPreviewPage() {
  ...
  const handleGenerate = async () => {
    ...
    setLoading(true);
    try {
      const deduction = await deductCredit(1, "geracao-diploma-anhanguera", creditRef("geracao-diploma-anhanguera", formData));
      if (!deduction.ok) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="glass relative mb-6 overflow-hidden rounded-xl" style={{ height: "70vh" }}>
        <PdfCanvasPreview pdfDataUrl={pdfBase64} title="Preview do Diploma Anhanguera" />
