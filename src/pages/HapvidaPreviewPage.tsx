...
export default function HapvidaPreviewPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const deduction = await deductCredit(1, "geracao-hapvida", creditRef("geracao-hapvida", formData));
      if (!deduction.ok) {
      ...
      // banco secundário. Espelhamos em SEGUNDO PLANO para não travar a entrega.
