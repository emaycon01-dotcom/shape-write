...
export default function AtestadoPreviewPage() {
  ...
  if (!pdfBase64 || !formData) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-20">
        ...
        <Button variant="outline" onClick={() => navigate("/dashboard/documents/atestado")}>
  ...
  const handleDownload = () => {
    try {
      ...
      link.href = url;
      link.download = "atestado-medico.pdf";
      link.click();
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <button
        onClick={() => navigate("/dashboard/documents/atestado")}
      ...
      <div className="glass relative mb-6 overflow-hidden rounded-xl" style={{ height: "70vh" }}>
        {pdfError ? (
          <div className="flex h-full flex-col items-center justify-center gap-4 p-8 text-center">
            ...
            <Button variant="outline" onClick={() => navigate("/dashboard/documents/atestado")} className="gap-1.5">
