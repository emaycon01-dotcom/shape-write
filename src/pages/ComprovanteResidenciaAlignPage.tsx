...
const defaultFields: FieldDef[] = [
  { id: "nome1", label: "Nome (1ª vez)", sampleText: "GREICE KELLY DA SILVA", x: 160, y: 6, fontSize: 12.5, bold: true },
  { id: "nome2", label: "Nome (2ª vez)", sampleText: "GREICE KELLY DA SILVA", x: 62, y: 1005, fontSize: 11, bold: true },
