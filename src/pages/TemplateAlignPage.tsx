...
import templateBgUrl from "@/assets/template-cnh-bg-hq.webp";
import templateRgBgUrl from "@/assets/template-rg-bg-hq.webp";
import templateAtestadoBgUrl from "@/assets/template-atestado-bg-hq.jpg";
import templateCrlvBgUrl from "@/assets/template-crlv-bg-hq.webp";
import templateChaBgUrl from "@/assets/template-cha-bg-hq.webp";
...
// Defaults MUST match supabase/functions/generate-declaracao-pe-pdf/index.ts DECLARACAO_PE_DEFAULT_POSITIONS
...
export const defaultComprovanteFields: FieldDef[] = [
  ...
  { id: "chave_nf", label: "Chave da NF-e", sampleText: "3526 0207 5859 0000 0166 6600 0059 3886 6100 0106 7716", x: 374.3, y: 162.0, fontSize: 9.2, w: 224, bold: true },
  { id: "nota_fiscal_serie", label: "Nota fiscal / série", sampleText: "NOTA FISCAL Nº 593886610 - SÉRIE B", x: 374.3, y: 176.5, fontSize: 9.2, w: 224, bold: true },
  ...
  { id: "linha_digitavel", label: "Linha digitável", sampleText: "83640000001 12345678901 12345678901 12345678901", x: 65.9, y: 972.5, fontSize: 12.4, w: 450 },
  { id: "pagador", label: "Pagador", sampleText: "MARIA APARECIDA DOS SANTOS - 000.000.000-00", x: 125, y: 999, fontSize: 9.2, w: 350 },
  ...
  { id: "controle_rodape", label: "Rodapé: nº da conta", sampleText: "511917580397", x: 64.5, y: 1052.5, fontSize: 12.4, w: 130, bold: true },
...
// Defaults MUST match supabase/functions/generate-coelba-pdf/index.ts COELBA_DEFAULT_POSITIONS
export const defaultCoelbaFields: FieldDef[] = [
  { id: "danfe_titulo", label: "Título DANFE", sampleText: "DANFE - DOCUMENTO AUXILIAR DA NOTA FISCAL DE ENERGIA ELÉTRICA ELETRÔNICA", x: 216.2, y: 2.0, fontSize: 10.4, w: 500, bold: true },
  { id: "emissor_l1", label: "Emissor linha 1", sampleText: "COMPANHIA DE ELETRICIDADE DO ESTADO DA BAHIA", x: 216.2, y: 25.4, fontSize: 8.6, w: 330, bold: true },
  { id: "emissor_l2", label: "Emissor linha 2", sampleText: "AV.EDGARD SANTOS, 300, CABULA VI, SALVADOR, BAHIA CEP 41181-900 CNPJ", x: 216.2, y: 36.0, fontSize: 8.6, w: 330 },
  { id: "emissor_l3", label: "Emissor linha 3", sampleText: "15.139.629/0001-94 INSCRIÇÃO ESTADUAL 00478696", x: 216.2, y: 47.0, fontSize: 8.6, w: 330 },
  { id: "cliente_nome", label: "Nome do titular", sampleText: "GLEIDSON GALO PEDREIRA", x: 24.0, y: 96.5, fontSize: 9.8, w: 255, bold: true },
  { id: "cliente_cpf", label: "CPF", sampleText: "CPF: 062.145.695-06", x: 24.0, y: 109.4, fontSize: 8.3, w: 255 },
  { id: "cliente_endereco", label: "Endereço", sampleText: "ENDEREÇO: RUA 3 TRAVESSA SÃO JOSÉ DO EGITO N 03", x: 24.0, y: 120.6, fontSize: 8.3, w: 255 },
  { id: "cliente_bairro", label: "Bairro", sampleText: "FEDERAÇÃO", x: 24.0, y: 131.6, fontSize: 8.3, w: 255 },
  { id: "cliente_cep", label: "CEP / cidade / UF", sampleText: "40220-535 SALVADOR BA", x: 22.7, y: 150.2, fontSize: 8.3, w: 255 },
  { id: "nf_linha", label: "Nota fiscal / emissão", sampleText: "NOTA FISCAL N° 790922648- SÉRIE 000 / DATA DE EMISSÃO: 22/11/2024", x: 515.1, y: 116.6, fontSize: 6.6, w: 265 },
  { id: "nf_consulta_label", label: "Rótulo consulta", sampleText: "Consulte pela Chave de Acesso em:", x: 515.1, y: 128.8, fontSize: 6.6, w: 265 },
  { id: "nf_consulta_url", label: "URL de consulta", sampleText: "https://dfe-portal.svrs.rs.gov.br/Nf3e/consulta", x: 515.1, y: 140.6, fontSize: 6.6, w: 265 },
  { id: "nf_chave_label", label: "Rótulo chave", sampleText: "chave de acesso:", x: 515.1, y: 151.0, fontSize: 6.6, w: 265 },
  { id: "nf_chave", label: "Chave de acesso", sampleText: "2924 0615 1396 2900 0194 6600 0790 9226 4820 3359 5373", x: 515.1, y: 163.4, fontSize: 6.6, w: 265 },
  { id: "nf_protocolo", label: "Protocolo", sampleText: "Protocolo de autorização: 3292400031937930 - 22/11/2024 às 13:47:00", x: 515.1, y: 172.8, fontSize: 6.6, w: 265 },
  { id: "referencia_topo", label: "Referência (topo)", sampleText: "12/2024", x: 21.0, y: 184.0, fontSize: 15.0, w: 92, bold: true },
  { id: "total_topo", label: "Total a pagar (topo)", sampleText: "597,80", x: 196.0, y: 185.5, fontSize: 14.5, w: 78, bold: true },
  { id: "vencimento_topo", label: "Vencimento (topo)", sampleText: "01/01/2025", x: 281.0, y: 184.0, fontSize: 15.0, w: 112, bold: true },
  { id: "lbl_datas", label: "Rótulo DATAS DE LEITURAS", sampleText: "DATAS DE LEITURAS", x: 56.0, y: 290.4, fontSize: 8.0, w: 110 },
  { id: "lbl_leitura_anterior", label: "Rótulo leitura anterior", sampleText: "LEITURA ANTERIOR", x: 180.2, y: 290.4, fontSize: 8.0, w: 90 },
  { id: "val_leitura_anterior", label: "Leitura anterior", sampleText: "23/10/2024", x: 262, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "lbl_leitura_atual", label: "Rótulo leitura atual", sampleText: "LEITURA ATUAL", x: 338.9, y: 290.4, fontSize: 8.0, w: 70 },
  { id: "val_leitura_atual", label: "Leitura atual", sampleText: "22/12/2024", x: 415, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "lbl_dias", label: "Rótulo nº de dias", sampleText: "N° DE DIAS", x: 519.1, y: 290.4, fontSize: 8.0, w: 60 },
  { id: "val_dias", label: "Nº de dias", sampleText: "30", x: 578, y: 287.6, fontSize: 10.3, w: 40, bold: true },
  { id: "lbl_proxima", label: "Rótulo próxima leitura", sampleText: "PRÓXIMA LEITURA", x: 636.5, y: 290.4, fontSize: 8.0, w: 90 },
  { id: "val_proxima", label: "Próxima leitura", sampleText: "24/01/2025", x: 706, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "med_postos", label: "Medidor: postos", sampleText: "Único", x: 163.0, y: 638.5, fontSize: 6.6, w: 48 },
  { id: "med_leitura_anterior", label: "Medidor: leitura anterior", sampleText: "11.312,00", x: 217.0, y: 638.5, fontSize: 6.6, w: 51 },
  { id: "med_leitura_atual", label: "Medidor: leitura atual", sampleText: "11.778,00", x: 274.0, y: 638.5, fontSize: 6.6, w: 50 },
  { id: "med_constante", label: "Medidor: constante", sampleText: "1,00000", x: 330.0, y: 638.5, fontSize: 6.6, w: 56 },
  { id: "med_consumo", label: "Medidor: consumo kWh", sampleText: "466,00", x: 392.0, y: 638.5, fontSize: 6.6, w: 57 },
  { id: "aviso_suspensao", label: "Aviso de suspensão", sampleText: "ATENÇÃO! APÓS 08/12/2024, DÉBITOS EXISTENTES CAUSARÃO SUSPENSÃO DO FORNECIMENTO.", x: 22.7, y: 689.0, fontSize: 9.6, w: 560, bold: true },
  { id: "deb_h1", label: "Débitos: cab. Vencto 1", sampleText: "Vencto", x: 26.7, y: 700.2, fontSize: 9.3, w: 60 },
  { id: "deb_h2", label: "Débitos: cab. Dt reaviso 1", sampleText: "Dt reaviso", x: 132.1, y: 700.2, fontSize: 9.3, w: 70 },
  { id: "deb_h3", label: "Débitos: cab. Valor 1", sampleText: "Valor", x: 250.9, y: 700.2, fontSize: 9.3, w: 50 },
  { id: "deb_h4", label: "Débitos: cab. Vencto 2", sampleText: "Vencto", x: 329.6, y: 700.2, fontSize: 9.3, w: 60 },
  { id: "deb_h5", label: "Débitos: cab. Dt reaviso 2", sampleText: "Dt reaviso", x: 427.0, y: 700.2, fontSize: 9.3, w: 70 },
  { id: "deb_h6", label: "Débitos: cab. Valor 2", sampleText: "Valor", x: 523.1, y: 700.2, fontSize: 9.3, w: 50 },
  { id: "deb_venc1", label: "Débito 1: vencto", sampleText: "31/08/24", x: 26.7, y: 712.2, fontSize: 8.6, w: 70 },
  { id: "deb_reaviso1", label: "Débito 1: dt reaviso", sampleText: "22/09/24", x: 134.8, y: 712.2, fontSize: 8.6, w: 70 },
  { id: "deb_valor1", label: "Débito 1: valor", sampleText: "619,09", x: 246.9, y: 712.2, fontSize: 8.6, w: 60 },
  { id: "deb_venc2", label: "Débito 2: vencto", sampleText: "30/09/24", x: 329.6, y: 712.2, fontSize: 8.6, w: 70 },
  ...
  { id: "rodape_vencimento", label: "Rodapé: vencimento", sampleText: "01/01/2024", x: 450, y: 904.0, fontSize: 13.0, w: 84, bold: true },
  ...
  { id: "p2_bairro", label: "P2: Bairro", sampleText: "FEDERAÇÃO", x: 22.7, y: 1667.0, fontSize: 8.3, w: 300 },
...
const EDITORS: Record<DocKey, EditorConfig> = {
  ...
  "declaracao-pe": {
    key: "declaracao-pe",
    title: "Declaração Escolar",
    storageKey: DECLARACAO_PE_ALIGN_STORAGE_KEY,
    defaults: defaultDeclaracaoPeFields,
    bg: templateDeclaracaoPeAsset.url,
    font: DECLARACAO_FONT,
    mrzFont: DECLARACAO_FONT,
    mrzWidth: 400,
    estadoBoxW: 240,
    estadoMaxChars: 40,
    mrzLineHeight: 2.0,
    copy: () => loadDeclaracaoPeFieldPositions() ?? {},
  },
  receita: {
    key: "receita",
  ...
  porte: {
    key: "porte",
    title: "Porte Federal de Arma",
    storageKey: PORTE_ALIGN_STORAGE_KEY,
    defaults: defaultPorteFields,
    bg: templatePorteBgUrl,
    pageW: 1123,
    pageH: 794,
    font: "Helvetica, Arial, 'Liberation Sans', sans-serif",
    mrzFont: "Helvetica, Arial, sans-serif",
    mrzWidth: 400,
    estadoBoxW: 240,
    estadoMaxChars: 40,
    mrzLineHeight: 1.2,
    copy: () => loadPorteFieldPositions() ?? {},
  },
  unip: {
    key: "unip",
    title: "Diploma UNIP",
