...
const defaultFisicaFrenteFields: FieldDef[] = [
  ...
  { id: "cat_big", label: "Cat. Grande", sampleText: "AB", x: 329, y: 121, fontSize: 11 },
  { id: "rg", label: "RG", sampleText: "3963221 SSP PR", x: 183, y: 142, fontSize: 6.5 },
  { id: "cpf", label: "CPF", sampleText: "997.038.350-25", x: 183, y: 161, fontSize: 6.5 },
  ...
  { id: "nacionalidade", label: "Nacionalidade", sampleText: "BRASILEIRA", x: 183, y: 180, fontSize: 6.5 },
  ...
  { id: "renach", label: "RENACH", sampleText: "PB527125303", x: 275, y: 427, fontSize: 6.5 },
  { id: "local", label: "Local", sampleText: "RIO DE JANEIRO, RJ", x: 91, y: 434, fontSize: 6 },
  { id: "estado", label: "Estado", sampleText: "BAHIA", x: 160, y: 446, fontSize: 15, color: "#1a5c2a" },
  { id: "reg_vert_top", label: "Reg. Vertical (topo)", sampleText: "07915888995", x: 58, y: 256, fontSize: 15, rotate: -90 },
  { id: "reg_vert_bot", label: "Reg. Vertical (base)", sampleText: "07915888995", x: 62, y: 490, fontSize: 15, rotate: -90 },
];
