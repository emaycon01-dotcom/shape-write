...
import templateFisicaBgUrl from "@/assets/template-cnh-fisica-bg-hq.jpg";
import templateFisicaVersoBgUrl from "@/assets/template-cnh-fisica-verso-hq.jpg";
        ...
        <TabsContent value="digitais">
          <Tabs defaultValue="cnh" className="w-full">
            <TabsList className="mb-4">
              ...
              <TabsTrigger value="certificado-escolar">CERT. ESCOLAR</TabsTrigger>
            </TabsList>
