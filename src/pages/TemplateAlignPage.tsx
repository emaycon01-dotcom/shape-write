...
const defaultFields: FieldDef[] = [
  ...
  { id: "nome", label: "Nome", sampleText: "MARIA OLIVEIRA SANTOS", x: 102, y: 145, fontSize: 8 },
  { id: "primeira_hab", label: "1ª Hab", sampleText: "27/09/2017", x: 307, y: 147, fontSize: 7.5 },
  { id: "nascimento", label: "Nascimento", sampleText: "11/03/1989, RIO DE JANEIRO, RJ", x: 190, y: 166, fontSize: 7 },
  { id: "emissao", label: "Emissão", sampleText: "14/03/2026", x: 190, y: 186, fontSize: 7.5 },
  { id: "validade", label: "Validade", sampleText: "14/03/2036", x: 248, y: 185, fontSize: 7.5, color: "#c00" },
  { id: "cat_big", label: "Cat. Grande", sampleText: "AB", x: 336, y: 183, fontSize: 10 },
  { id: "validade_cat_a", label: "Validade Cat. A", sampleText: "14/03/2036", x: 168, y: 349, fontSize: 5 },
  { id: "validade_cat_b", label: "Validade Cat. B", sampleText: "14/03/2036", x: 170, y: 371, fontSize: 5 },
  { id: "validade_cat_c", label: "Validade Cat. C", sampleText: "14/03/2036", x: 171, y: 394, fontSize: 5 },
  { id: "validade_cat_d", label: "Validade Cat. D", sampleText: "14/03/2036", x: 271, y: 338, fontSize: 5 },
  { id: "validade_cat_e", label: "Validade Cat. E", sampleText: "14/03/2036", x: 271, y: 361, fontSize: 5 },
  { id: "rg", label: "RG", sampleText: "3963221 SSP PR", x: 190, y: 206, fontSize: 7 },
  { id: "cpf", label: "CPF", sampleText: "997.038.350-25", x: 191, y: 223, fontSize: 7.5 },
  { id: "registro", label: "Registro", sampleText: "07915888995", x: 257, y: 224, fontSize: 7.5 },
  { id: "cat_hab", label: "Cat. Hab", sampleText: "AB", x: 317, y: 226, fontSize: 7 },
  { id: "nacionalidade", label: "Nacionalidade", sampleText: "BRASILEIRA", x: 190, y: 243, fontSize: 7 },
  ...
  { id: "espelho", label: "Nº Espelho", sampleText: "77424319856", x: 274, y: 492, fontSize: 6.5 },
  { id: "renach", label: "RENACH", sampleText: "PB527125303", x: 273, y: 503, fontSize: 6.5 },
  { id: "local", label: "Local", sampleText: "RIO DE JANEIRO, RJ", x: 95, y: 505, fontSize: 6 },
