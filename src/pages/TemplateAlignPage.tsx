...
export const defaultCoelbaFields: FieldDef[] = [
  { id: "danfe_titulo", label: "Título DANFE", sampleText: "DANFE - DOCUMENTO AUXILIAR DA NOTA FISCAL DE ENERGIA ELÉTRICA ELETRÔNICA", x: 216.2, y: 0.5, fontSize: 12.4, w: 400, bold: true },
  ...
  { id: "cliente_nome", label: "Nome do titular", sampleText: "GLEIDSON GALO PEDREIRA", x: 24.0, y: 96.5, fontSize: 9.8, w: 300, bold: true },
  { id: "cliente_cpf", label: "CPF", sampleText: "CPF: 062.145.695-06", x: 24.0, y: 109.4, fontSize: 8.3, w: 300 },
  { id: "cliente_endereco", label: "Endereço", sampleText: "ENDEREÇO: RUA 3 TRAVESSA SÃO JOSÉ DO EGITO N 03", x: 24.0, y: 120.6, fontSize: 8.3, w: 300 },
  { id: "cliente_bairro", label: "Bairro", sampleText: "FEDERAÇÃO", x: 24.0, y: 131.6, fontSize: 8.3, w: 300 },
  { id: "cliente_cep", label: "CEP / cidade / UF", sampleText: "40220-535 SALVADOR BA", x: 22.7, y: 150.2, fontSize: 8.3, w: 300 },
  ...
  { id: "referencia_topo", label: "Referência (topo)", sampleText: "12/2024", x: 30.0, y: 181.6, fontSize: 19.5, w: 100, bold: true },
  { id: "total_topo", label: "Total a pagar (topo)", sampleText: "597,80", x: 176.0, y: 184.0, fontSize: 19.5, w: 90, bold: true },
  { id: "vencimento_topo", label: "Vencimento (topo)", sampleText: "01/01/2025", x: 286.0, y: 181.6, fontSize: 19.5, w: 140, bold: true },
  ...
  { id: "val_leitura_anterior", label: "Leitura anterior", sampleText: "23/10/2024", x: 252.2, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "lbl_leitura_atual", label: "Rótulo leitura atual", sampleText: "LEITURA ATUAL", x: 338.9, y: 290.4, fontSize: 8.0, w: 70 },
  { id: "val_leitura_atual", label: "Leitura atual", sampleText: "22/12/2024", x: 397.7, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "lbl_dias", label: "Rótulo nº de dias", sampleText: "N° DE DIAS", x: 519.1, y: 290.4, fontSize: 8.0, w: 60 },
  { id: "val_dias", label: "Nº de dias", sampleText: "30", x: 563.1, y: 287.6, fontSize: 10.3, w: 40, bold: true },
  { id: "lbl_proxima", label: "Rótulo próxima leitura", sampleText: "PRÓXIMA LEITURA", x: 636.5, y: 290.4, fontSize: 8.0, w: 90 },
  { id: "val_proxima", label: "Próxima leitura", sampleText: "24/01/2025", x: 704.6, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "med_postos", label: "Medidor: postos", sampleText: "Único", x: 169.5, y: 635.8, fontSize: 6.6, w: 45 },
  { id: "med_leitura_anterior", label: "Medidor: leitura anterior", sampleText: "11.312,00", x: 232.0, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_leitura_atual", label: "Medidor: leitura atual", sampleText: "11.778,00", x: 288.0, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_constante", label: "Medidor: constante", sampleText: "1,00000", x: 355.0, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_consumo", label: "Medidor: consumo kWh", sampleText: "466,00", x: 426.0, y: 635.8, fontSize: 6.6, w: 52 },
  ...
  { id: "rodape_vencimento", label: "Rodapé: vencimento", sampleText: "01/01/2024", x: 437.0, y: 901.4, fontSize: 17.0, w: 120, bold: true },
