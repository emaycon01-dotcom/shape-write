...
export const defaultCoelbaFields: FieldDef[] = [
  ...
  { id: "total_topo", label: "Total a pagar (topo)", sampleText: "597,80", x: 195, y: 184.0, fontSize: 19.5, w: 85, bold: true },
  ...
  { id: "val_leitura_anterior", label: "Leitura anterior", sampleText: "23/10/2024", x: 270, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  ...
  { id: "val_proxima", label: "Próxima leitura", sampleText: "24/01/2025", x: 722, y: 287.6, fontSize: 10.3, w: 80, bold: true },
  { id: "med_postos", label: "Medidor: postos", sampleText: "Único", x: 169.5, y: 635.8, fontSize: 6.6, w: 45 },
  { id: "med_leitura_anterior", label: "Medidor: leitura anterior", sampleText: "11.312,00", x: 224, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_leitura_atual", label: "Medidor: leitura atual", sampleText: "11.778,00", x: 280, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_constante", label: "Medidor: constante", sampleText: "1,00000", x: 347, y: 635.8, fontSize: 6.6, w: 52 },
  { id: "med_consumo", label: "Medidor: consumo kWh", sampleText: "466,00", x: 392, y: 635.8, fontSize: 6.6, w: 52 },
  ...
  { id: "rodape_vencimento", label: "Rodapé: vencimento", sampleText: "01/01/2024", x: 470, y: 901.4, fontSize: 17.0, w: 120, bold: true },
