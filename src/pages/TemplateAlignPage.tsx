...
const defaultFields: FieldDef[] = [
  ...
  { id: "signature", label: "Assinatura", sampleText: "[ASSINATURA]", x: 94, y: 277, fontSize: 7, w: 95, h: 32, color: "#999" },
  { id: "nome", label: "Nome", sampleText: "MARIA OLIVEIRA SANTOS", x: 98, y: 146, fontSize: 8 },
  { id: "primeira_hab", label: "1ª Hab", sampleText: "27/09/2017", x: 305, y: 147, fontSize: 7.5 },
  { id: "nascimento", label: "Nascimento", sampleText: "11/03/1989, RIO DE JANEIRO, RJ", x: 186, y: 167, fontSize: 7 },
  { id: "emissao", label: "Emissão", sampleText: "14/03/2026", x: 186, y: 185, fontSize: 7.5 },
  { id: "validade", label: "Validade", sampleText: "14/03/2036", x: 247, y: 185, fontSize: 7.5, color: "#c00" },
  { id: "cat_big", label: "Cat. Grande", sampleText: "AB", x: 334, y: 183, fontSize: 10 },
  { id: "validade_cat_a", label: "Validade Cat. A", sampleText: "14/03/2036", x: 137, y: 351, fontSize: 5.5 },
  { id: "validade_cat_b", label: "Validade Cat. B", sampleText: "14/03/2036", x: 137, y: 372, fontSize: 5.5 },
  { id: "validade_cat_c", label: "Validade Cat. C", sampleText: "14/03/2036", x: 136, y: 395, fontSize: 5.5 },
  { id: "validade_cat_d", label: "Validade Cat. D", sampleText: "14/03/2036", x: 271, y: 339, fontSize: 5.5 },
  { id: "validade_cat_e", label: "Validade Cat. E", sampleText: "14/03/2036", x: 271, y: 362, fontSize: 5.5 },
  { id: "rg", label: "RG", sampleText: "3963221 SSP PR", x: 188, y: 206, fontSize: 7 },
  { id: "cpf", label: "CPF", sampleText: "997.038.350-25", x: 189, y: 224, fontSize: 7.5 },
  { id: "registro", label: "Registro", sampleText: "07915888995", x: 254, y: 224, fontSize: 7.5 },
  { id: "cat_hab", label: "Cat. Hab", sampleText: "AB", x: 314, y: 224, fontSize: 7 },
  { id: "nacionalidade", label: "Nacionalidade", sampleText: "BRASILEIRA", x: 187, y: 243, fontSize: 7.5 },
