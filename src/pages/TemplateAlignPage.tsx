...
const defaultFields: FieldDef[] = [
  ...
  { id: "signature", label: "Assinatura", sampleText: "[ASSINATURA]", x: 92, y: 274, fontSize: 7, w: 95, h: 32, color: "#999" },
  { id: "nome", label: "Nome", sampleText: "MARIA OLIVEIRA SANTOS", x: 96, y: 144, fontSize: 8.5 },
  { id: "primeira_hab", label: "1ª Hab", sampleText: "27/09/2017", x: 303, y: 144, fontSize: 7.5 },
  { id: "nascimento", label: "Nascimento", sampleText: "11/03/1989, RIO DE JANEIRO, RJ", x: 187, y: 165, fontSize: 7 },
  { id: "emissao", label: "Emissão", sampleText: "14/03/2026", x: 188, y: 184, fontSize: 7.5 },
  { id: "validade", label: "Validade", sampleText: "14/03/2036", x: 246, y: 184, fontSize: 7.5, color: "#c00" },
  { id: "cat_big", label: "Cat. Grande", sampleText: "AB", x: 336, y: 181, fontSize: 10 },
  { id: "validade_cat", label: "Validade Cat.", sampleText: "14/03/2036", x: 380, y: 200, fontSize: 7, color: "#c00" },
  { id: "validade_cat_a", label: "Validade Cat. A", sampleText: "14/03/2036", x: 168, y: 420, fontSize: 6.5 },
  { id: "validade_cat_b", label: "Validade Cat. B", sampleText: "14/03/2036", x: 168, y: 453, fontSize: 6.5 },
  { id: "validade_cat_c", label: "Validade Cat. C", sampleText: "14/03/2036", x: 168, y: 486, fontSize: 6.5 },
  { id: "validade_cat_d", label: "Validade Cat. D", sampleText: "14/03/2036", x: 360, y: 404, fontSize: 6.5 },
  { id: "validade_cat_e", label: "Validade Cat. E", sampleText: "14/03/2036", x: 360, y: 420, fontSize: 6.5 },
  { id: "rg", label: "RG", sampleText: "3963221 SSP PR", x: 188, y: 204, fontSize: 7 },
  { id: "cpf", label: "CPF", sampleText: "997.038.350-25", x: 186, y: 222, fontSize: 7.5 },
  { id: "registro", label: "Registro", sampleText: "07915888995", x: 255, y: 222, fontSize: 7.5 },
  { id: "cat_hab", label: "Cat. Hab", sampleText: "AB", x: 315, y: 223, fontSize: 6 },
  { id: "nacionalidade", label: "Nacionalidade", sampleText: "BRASILEIRA", x: 190, y: 241, fontSize: 7.5 },
  { id: "pai", label: "Pai", sampleText: "JOSE DA SILVA", x: 191, y: 265, fontSize: 7.5 },
  { id: "mae", label: "Mãe", sampleText: "SANDRA COSTA", x: 191, y: 286, fontSize: 7.5 },
  { id: "obs", label: "Observações", sampleText: "EAR", x: 97, y: 427, fontSize: 5.5 },
  { id: "espelho", label: "Nº Espelho", sampleText: "77424319856", x: 276, y: 495, fontSize: 6.5 },
  { id: "renach", label: "RENACH", sampleText: "PB527125303", x: 275, y: 510, fontSize: 6.5 },
  { id: "local", label: "Local", sampleText: "RIO DE JANEIRO, RJ", x: 94, y: 503, fontSize: 7 },
  ...
  { id: "reg_vert_top", label: "Reg. Vertical (topo)", sampleText: "07915888995", x: 63, y: 311, fontSize: 10.5, rotate: -90 },
  { id: "reg_vert_bot", label: "Reg. Vertical (base)", sampleText: "07915888995", x: 59, y: 551, fontSize: 10.5, rotate: -90 },
];
