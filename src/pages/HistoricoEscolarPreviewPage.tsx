...
const DEFAULT_POSITIONS: Record<string, FieldPos> = {
  ...
  telefone: { x: 186, y: 122, fontSize: 7 },
  nomeAluno: { x: 111, y: 170, fontSize: 7 },
  dataNascimento: { x: 116, y: 186, fontSize: 8.5 },
  nomeMae: { x: 364, y: 193, fontSize: 7 },
  estadoAluno: { x: 377, y: 179, fontSize: 8 },
  rg: { x: 357, y: 168, fontSize: 7 },
  municipioCabecalho: { x: 314, y: 106, fontSize: 7 },
  anoFundamental: { x: 178, y: 559, fontSize: 6 },
  escolaFundamental: { x: 293, y: 590, fontSize: 6 },
  ufFundamental: { x: 525, y: 577, fontSize: 6 },
  municipioFundamental: { x: 453, y: 576, fontSize: 6 },
  medioAno1: { x: 188, y: 577, fontSize: 6 },
