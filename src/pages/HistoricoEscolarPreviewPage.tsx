...
const DEFAULT_POSITIONS: Record<string, FieldPos> = {
  brasao: { x: 65, y: 56, fontSize: 9, w: 55, h: 65 },
  estadoEscola1: { x: 321, y: 24, fontSize: 13 },
  estadoEscola2: { x: 525, y: 554, fontSize: 8 },
  endereco: { x: 195, y: 94, fontSize: 7 },
  numero: { x: 493, y: 94, fontSize: 7 },
  bairro: { x: 178, y: 104, fontSize: 7 },
  municipioEscola: { x: 453, y: 554, fontSize: 8 },
  cep: { x: 478, y: 106, fontSize: 7 },
  telefone: { x: 186, y: 120, fontSize: 7 },
  nomeAluno: { x: 114, y: 166, fontSize: 7 },
  dataNascimento: { x: 117, y: 182, fontSize: 8.5 },
  nomeMae: { x: 366, y: 191, fontSize: 7 },
  estadoAluno: { x: 378, y: 176, fontSize: 8 },
  rg: { x: 360, y: 165, fontSize: 7 },
  municipioCabecalho: { x: 316, y: 104, fontSize: 7 },
  anoFundamental: { x: 240, y: 727, fontSize: 6 },
  escolaFundamental: { x: 291, y: 552, fontSize: 6 },
  ufFundamental: { x: 525, y: 576, fontSize: 6 },
  municipioFundamental: { x: 454, y: 576, fontSize: 6 },
  medioAno1: { x: 192, y: 557, fontSize: 6 },
  medioEscola1: { x: 290, y: 600, fontSize: 6 },
  medioUf1: { x: 525, y: 587, fontSize: 6 },
  medioMunicipio1: { x: 455, y: 587, fontSize: 6 },
  medioAno2: { x: 189, y: 578, fontSize: 6 },
  medioEscola2: { x: 288, y: 578, fontSize: 6 },
  medioUf2: { x: 524, y: 598, fontSize: 6 },
  medioMunicipio2: { x: 455, y: 598, fontSize: 6 },
  ...
  escolaConclusao: { x: 291, y: 590, fontSize: 6 },
  nomeConcludente: { x: 248, y: 276, fontSize: 6 },
  anoFinalizacao: { x: 135, y: 665, fontSize: 10.5 },
};
