...
export default function HistoricoPreviewPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const deduction = await deductCredit(1, "geracao-historico", creditRef("geracao-historico", formData));
      if (!deduction.ok) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="glass relative mb-6 overflow-hidden rounded-xl" style={{ height: "70vh" }}>
        <PdfCanvasPreview pdfDataUrl={pdfBase64} title="Preview do HISTÓRICO + CERTIFICADO" />
