...
<div class="page">
  ...
  <!-- MRZ on verso page -->
  <div class="overlay" style="top:424px;left:450px;width:460px;font-family:'Courier New',Courier,monospace;font-size:15px;color:#111;letter-spacing:1.6px;line-height:1.6;white-space:pre-line;">${mrz.line1}<br>${mrz.line2}<br>${mrz.line3}</div>
</div>
</body>
</html>`;
}
