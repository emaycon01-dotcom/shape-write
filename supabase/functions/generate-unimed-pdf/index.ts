...
<div class="page">
  ...
  ${d.assinatura_base64 ? `<div class="overlay sig-mask" style="top:492px;left:218px;width:360px;height:116px;"></div><div class="overlay sig" style="${boxStyle("assinatura_img")}"><img src="${escapeHtml(d.assinatura_base64)}" /></div><div class="sig-rule" style="top:609px;left:238px;width:292px;"></div>` : ""}
