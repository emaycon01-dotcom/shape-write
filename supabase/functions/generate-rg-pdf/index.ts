...
export const RG_DEFAULT_POSITIONS: Record<string, Pos> = {
  ...
  signature: { x: 171, y: 324, fontSize: 7, w: 140, h: 28 },
  estado: { x: 243, y: 142, fontSize: 9 },
  nome: { x: 159, y: 202, fontSize: 9 },
  nome_social: { x: 159, y: 232, fontSize: 9 },
  registro_geral: { x: 160, y: 263, fontSize: 9 },
  sexo: { x: 298, y: 261, fontSize: 11 },
  data_nascimento: { x: 160, y: 285, fontSize: 9 },
  nacionalidade: { x: 300, y: 285, fontSize: 9 },
  naturalidade: { x: 160, y: 307, fontSize: 9 },
  data_validade: { x: 300, y: 308, fontSize: 9 },
  // Verso
  qr: { x: 50, y: 437, fontSize: 8, w: 82, h: 82 },
  qr2: { x: 504, y: 94, fontSize: 8, w: 240, h: 240 },
  photo2: { x: 397, y: 421, fontSize: 8, w: 36, h: 37 },
  filiacao1: { x: 152, y: 433, fontSize: 9 },
  filiacao2: { x: 153, y: 451, fontSize: 9 },
  orgao_expedidor: { x: 154, y: 482, fontSize: 9 },
  local_emissao: { x: 154, y: 517, fontSize: 9 },
  data_emissao: { x: 328, y: 517, fontSize: 9 },
  mrz: { x: 58, y: 598, fontSize: 16 },
  // Outras informações
  titulo_eleitor: { x: 40, y: 743, fontSize: 9 },
  tipo_sanguineo: { x: 297, y: 744, fontSize: 9 },
  estado_civil: { x: 39, y: 774, fontSize: 9 },
  doador: { x: 296, y: 774, fontSize: 9 },
  signature2: { x: 49, y: 809, fontSize: 10, w: 90, h: 33 },
  certidao: { x: 214, y: 805, fontSize: 8.5 },
  cnh: { x: 40, y: 861, fontSize: 9 },
  categoria: { x: 176, y: 861, fontSize: 9 },
  pis_pasep: { x: 310, y: 862, fontSize: 9 },
  nis: { x: 40, y: 891, fontSize: 9 },
  nit: { x: 175, y: 893, fontSize: 9 },
  ctps: { x: 310, y: 893, fontSize: 9 },
  dni: { x: 40, y: 923, fontSize: 9 },
  cns: { x: 295, y: 923, fontSize: 9 },
  observacao_saude: { x: 42, y: 955, fontSize: 11 },
};
